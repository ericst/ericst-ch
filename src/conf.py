...
BLOG_AUTHOR = "Eric Seuret"  # (translatable)
BLOG_TITLE = "Eric S."  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "http://ericst.ch/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "http://ericst.ch/"
BLOG_EMAIL = "eric@ericst.ch"
BLOG_DESCRIPTION = "Just some random stuffs."  # (translatable)
...
NAVIGATION_LINKS = {
    DEFAULT_LANG: (
        ...
        ('/pages/projects.html', 'My Projects', 'icon-book'),
        ('https://github.com/ericst', 'My Github', 'icon-github'),
        ('https://ch.linkedin.com/in/ericseuret', 'My LinkedIn Profile', 'icon-linkedin'),
        ('/tags/index.html', 'Tags', 'icon-tags'),
        ('/archive.html', 'Archives', 'icon-calendar'),
